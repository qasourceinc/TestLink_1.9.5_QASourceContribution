...
<script type="text/javascript" src='{$basehref}gui/javascript/jquery.min.js'></script>
<script type="text/javascript" src='{$basehref}gui/javascript/jquery-ui-1.7.1.custom.min.js'></script>
 ...
 * Author : QASource
 * Defect ID : 5751
 * This function will send ajax call to loadTreeAjax_test.php. This is new function for ajax call implementation.
 *				 
 **/
function ajaxRequest(parentID,b,plan_id,grandParentID,build_id){
	
	{/literal}
	var url	=	'{$control->args->basehref}'+"lib/ajax/loadTreeAjax_test.php?parentID="+parentID+"&plan_id="+plan_id+"&grandParentID="+grandParentID+"&build_id="+build_id; 
	{literal}
...
{*  
	Author : QASource
	Defect ID : 5751
	This will load the loading image when click on folder
 *}
<br />
<div id="loadDiv" style=" position: absolute; display:none; margin:auto; left:25%; width: 100px; margin-top:20px; height: 100px; z-index:999; background:none;">
	<img src='third_party/ext-js/images/default/shared/ajax-loader.gif'/>
</div>
{* updated code ends *}
