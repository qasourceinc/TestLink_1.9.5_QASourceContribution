...
<div class="menu_title" style=" float:right;">
	...
	<span class="bold" style="font:Trebuchet MS; color:#2E7FC1; font-size:21px; font-weight:bold; " >Testcase Management System195 {$VERSION}</span>: {$gui->whoami|escape}</span>
...
<div style="display:block; float:left; height=70px" >
	...
	<img alt="Company logo"	title="logo" style="width: 150px; height:60px; margin-top:10px;" 
