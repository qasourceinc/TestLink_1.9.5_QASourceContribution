 ...
 * Author : QASource
 * Defect ID : 5751
 * Storing build session id's used in case filters
 *				 
 **/
$a			=	$control->settings;
$_SESSION['t_build_id']	=	$a['setting_build']['selected'];
/* updated code ends */
 ...
 * Author: QASource
 * Defect ID : 5751
 * Remove 2 filters(Nobody, Somebody)
 * These were removed because no clauses in filter functionality were being made as per our functionality.			 
 **/
unset($control->filters['filter_assigned_user']['items']['-1']);
unset($control->filters['filter_assigned_user']['items']['-2']);
/* updated code ends */
